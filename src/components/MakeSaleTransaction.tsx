...
import { deductProductQuantity } from "@/server/input/transacton";
...
export default function MakeSaleTransaction({
  isLink = false,
  className = "",
  products,
}: {
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    const res = await deductProductQuantity(data.productId, data.qty);
    if (res.status === "error") {
      toast.error(res.msg);
    } else {
      form.reset();

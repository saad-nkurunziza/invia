...
export const CreateProductVersionFormSchema = z.object({
  name: z.string().min(2, {
...
const CreateProductVersion = ({
  ...
  const form = useForm<z.infer<typeof CreateProductVersionFormSchema>>({
    resolver: zodResolver(CreateProductVersionFormSchema),
    defaultValues: {
      name: "",
      description: "",
      stock: 1,
  ...
  async function onSubmit(
    data: z.infer<typeof CreateProductVersionFormSchema>
  ) {
...
export default CreateProductVersion;
